...
public class Player1 extends InputCoordinatesShip {
    ...
    private static String[][] arrayWithoutShipsPlayer1;

    public static String[][] getArrayWithoutShipsPlayer1() {
        return arrayWithoutShipsPlayer1;
    }
    ...
    public void inputCoordinates() {
        ...
        ShotPlayer2.copyArrayPlayer1 = Battleship.getArray();
        arrayWithoutShipsPlayer1 = Battleship.getArray();
        ...
        while (count > 0) {
            ...
            AddShips.addShipsOnField(firstStart, intStart, endStart, intEnd, ShotPlayer2.copyArrayPlayer1);
